...
## Conclusions
Amb **Duplicity** s’han configurat còpies completes i incrementals al servidor Linux.  
Els scripts asseguren que la unitat de backup només estigui muntada durant el procés de còpia.  
Mitjançant **cron**, el sistema queda totalment automatitzat, garantint còpies de seguretat fiables cada dia.
